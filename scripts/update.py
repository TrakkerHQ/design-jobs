#!/usr/bin/env python3
"""Pull Trakker's UI/UX postings and regenerate the README tables.

Runs once a day from .github/workflows/refresh.yml. Each run:

1. fetches every UI/UX intern/new-grad posting Trakker considers new in the
...
def fetch() -> list[dict]:
    ...
    request = urllib.request.Request(url, headers={
        ...
        "User-Agent": "trakker-design-jobs/1.0 (+https://github.com/TrakkerHQ/design-jobs)",
    })
    try:
